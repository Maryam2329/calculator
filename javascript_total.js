...
// SUBCONTAINER 4 with only clear button on the right (justify content)
const subcontainer4 = document.createElement('div');
subcontainer4.style.textAlign='left';
subcontainer4.appendChild(clearButtonObject.button);
